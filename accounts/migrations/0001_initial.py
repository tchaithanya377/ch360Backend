...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'id_type', 'is_primary'], name='accounts_au_user_id_93c765_idx')],
                'constraints': [models.UniqueConstraint(condition=models.Q(('is_primary', True)), fields=('user', 'id_type'), name='uniq_primary_identifier_per_type')],
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'used'], name='accounts_pa_user_id_dbf915_idx')],
            },
        ),
        migrations.CreateModel(
            name='RolePermission',
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user', 'revoked', 'expires_at'], name='accounts_us_user_id_5a6a2f_idx')],
            },
        ),
    ]
