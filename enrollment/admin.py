...
class FacultyAssignmentAdmin(admin.ModelAdmin):
    ...
    list_filter = ['status', 'is_primary', 'faculty__department_ref', 'course_section__academic_year', 'course_section__semester']
...
class EnrollmentRequestAdmin(admin.ModelAdmin):
    ...
    list_filter = ['status', 'course_section__academic_year', 'course_section__semester', 'course_section__course__department']
...
class WaitlistEntryAdmin(admin.ModelAdmin):
    ...
    list_filter = ['is_active', 'course_section__academic_year', 'course_section__semester', 'course_section__course__department']
