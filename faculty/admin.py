...
class FacultyAdmin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        'department', 'currently_associated', 'status', 'email', 'phone_number'
    ]
    list_filter = [
        'status', 'department', 'employment_type', 'designation',
    ...
    search_fields = [
        ...
        'apaar_faculty_id', 'email', 'phone_number', 'pan_no'
    ]
    readonly_fields = [
    ...
    fieldsets = (
        ...
        ('Employment Information', {
            'fields': (
                ...
                'experience_in_current_institute', 'designation', 'department',
