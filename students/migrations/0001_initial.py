...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['student', 'contact_type'], name='students_st_student_5e110b_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['student', 'id_type', 'is_primary'], name='students_st_student_a8cf9f_idx')],
